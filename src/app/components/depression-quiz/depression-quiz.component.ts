...
export class DepressionQuizComponent implements OnInit {
  ...
  getResultMessage(): string {
    ...
    if (percentage < 25) {
      return 'התוצאות מצביעות על רמה נמוכה של תסמיני דיכאון';
    } else if (percentage < 50) {
      return 'התוצאות מצביעות על רמה קלה של תסמיני דיכאון';
    } else if (percentage < 75) {
      return 'התוצאות מצביעות על רמה בינונית של תסמיני דיכאון';
    } else {
      return 'התוצאות מצביעות על רמה גבוהה של תסמיני דיכאון';
    }
  }
